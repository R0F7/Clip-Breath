  ...
  return (
    <section className="container mx-auto py-10 lg:py-20">
      <div className=" flex flex-col md:flex-row gap-6 lg:gap-[64px] px-4 md:px-0">
        ...
        {/* text site */}
        <div className="w-full md:w-3/5 g:w-1/2">
          ...
          <h4 className="text-[#12151A] text-4xl lg:text-[40px] font-semibold mb-2 leading-none">
            Noseclip
          </h4>
          <div className="flex items-center gap-x-2 mb-4 lg:mb-[38.5px]">
          ...
          <div>
            <h4 className="text-[#12151A] text-2xl lg:text-3xl font-semibold mb-1.5 lg:mb-3">
              Description:
            </h4>
            <p className="font-poppins mb-4 text-sm lg:text-base">
          ...
          <div className="block md:hidden lg:block">
            <div className="grid grid-cols-5 gap-4 my-6">
              <img src={pay1} alt="apple pay" />
              <img src={pay2} alt="google pay" />
              <img src={pay3} alt="mastercard" />
              <img src={pay4} alt="shop" />
              <img src={pay5} alt="visa card" />
            </div>
            <ul>
